# Traffic Patterns, Nontowered Operations, and Right of Way — QA checklist
...
- [x] Explicit current-turn authorization was received before source excerpts, claims, and tagged passages were sent to OpenAI for the `--require-llm` source-relevance review. <!-- qa-id: openai-source-review-authorization -->
