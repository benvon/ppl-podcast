# Aeromedical Factors and Human Performance — QA checklist
...
Authorization record, 2026-09-22: The user authorized sending this current editorial revision’s Core 20 source excerpts, claim inventory, and source-tagged master-script passages to OpenAI for two-pass source-relevance evaluation. The validation report must record this authorization with its run.
