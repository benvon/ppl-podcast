# Cross-Country Planning, Fuel, and Diversions — QA checklist
...
- [x] If human editorial changes factual spoken prose, source tags, claims, sources, or show notes, source-relevance validation was rerun successfully before audio render. No such change occurred after the completed source-relevance review. <!-- qa-id: post-editorial-source-relevance -->
...
- [x] Explicit current-turn authorization was received before the opening-preview narration was sent to OpenAI Realtime for audio rendering. <!-- qa-id: openai-audio-render-authorization -->
- [x] Explicit current-turn authorization was received before the remaining approved narration was sent to OpenAI Realtime for the full candidate render. <!-- qa-id: openai-full-audio-render-authorization -->
