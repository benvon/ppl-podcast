...
- [ ] Explicit current-turn authorization was received before source excerpts, claims, and tagged passages were sent to OpenAI for the `--require-llm` source-relevance review. <!-- qa-id: openai-source-review-authorization -->
