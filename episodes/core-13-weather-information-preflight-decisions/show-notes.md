...
Using an explicitly hypothetical VFR trip from Northern California to Wisconsin, this episode connects METARs, SPECIs, PIREPs, surface analysis, GFA layers, TAFs, winds aloft, advisories, and briefing types to the decisions they are meant to support. The lesson organizes weather evidence by route segment and time, shows how to identify each product’s limits, and builds clear triggers for delay, reroute, diversion, or landing short.
...
| Topic | Authoritative source | Locator |
| --- | --- | --- |
| ACS weather-information task | [Private Pilot Airplane ACS](https://www.faa.gov/training_testing/testing/acs/private_airplane_acs_6.pdf#page=11) | PA.I.C.K1-K4 and following risk/skill elements |
| Preflight obligation | [14 CFR 91.103](https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-B/section-91.103) | Opening sentence |
| Briefing process and briefing types | [AC 91-92](https://www.faa.gov/documentLibrary/media/Advisory_Circular/AC_91-92.pdf#page=7) | Paragraphs 7.3 and 7.4 |
| Weather-services overview | [PHAK Chapter 13](https://www.faa.gov/sites/faa.gov/files/15_phak_ch13.pdf#page=1) | Aviation Weather Services |
| Preflight briefing | [Aviation Weather Handbook](https://www.faa.gov/sites/faa.gov/files/FAA-H-8083-28B.pdf#page=26) | Chapter 3 |
