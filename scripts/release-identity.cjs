...
const TRACKS = Object.freeze({
  core: { idPrefix: "core", releasePrefix: "episode" },
  supplemental: { idPrefix: "supplement", releasePrefix: "supplement" },
  "rough-spots": { idPrefix: "rough", releasePrefix: "rough-spot" },
});
...
function releaseIdentity({ track, id, version }) {
  ...
  const match = new RegExp(`^${definition.idPrefix}-(\\d{2,3})$`).exec(id || "");
