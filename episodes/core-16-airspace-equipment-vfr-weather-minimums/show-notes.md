...
One fictional daytime cross-country turns airspace into a repeatable decision: locate the airplane in three dimensions, establish the communication or clearance required for entry, match the pilot and equipment to the full route, and apply the correct VFR visibility and cloud minimums. The route moves from Class G into Class E, stops in Class D, passes near Class C and beneath a Class B shelf inside its Mode C veil, and then uses lowering weather, an MOA, and a TFR to test the plan.
...
| Special VFR | Regulation | [14 CFR 91.157](https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-B/section-91.157) | 14 CFR 91.157(a)-(b) | Pending formal review |
