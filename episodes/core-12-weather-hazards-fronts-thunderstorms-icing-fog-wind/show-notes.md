...
Start with the PHAK pages for the private-pilot conceptual model. Use the current Aviation Weather Handbook pages for deeper frontal, thunderstorm, icing, and fog treatment. Use the ACS page to test whether you can turn the facts into a conservative decision. The Airplane Flying Handbook link is complementary context for the runway-wind question; aircraft-specific values and procedures belong to the current POH or AFM for the airplane being flown.
