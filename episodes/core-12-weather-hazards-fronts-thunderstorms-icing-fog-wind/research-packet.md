...
| Objective or risk-management item | Source locator | Scenario treatment |
| --- | --- | --- |
...
| Analyze implications and correlate information | PA.I.C.S2-S3 | Reuses one sequence: mechanism, three-dimensional location and timing, corroborating sources and cues, combined margin, concrete lower-workload choice. |
...
- Define each term when its route segment first needs it; do not open with a vocabulary list.
- Keep the surface-front mental picture concrete: the line is the ground intersection, the boundary leans over cold air, and associated weather can occupy a larger volume.
- Never write “actual evidence,” “this flight,” “both names,” or “usable alternatives.” Name the observations, forecasts, advisories, reports, cues, route segment, front type, and exact planning option.
- Do not let the route become an operational recommendation. Exact airports, altitudes, and current conditions remain outside the scenario.
- Keep source tags immediate and source-pure. Split factual paragraphs when the supporting source changes.
- In Retrieval review, tag every factual Instructor and Learner paragraph and list each recalled claim's section mapping.
- Preserve the standard opening order and listener-facing references to Episode 11 and Episode 13.
...
- Formal source-relevance review passed for version 0.2.2 on September 2, 2026 after the approved upslope-fog and crosswind-capability source-support corrections. The final input-bound package record is complete and is bound to the replacement audio’s approved narration.
