...
## 2026-08-24 — version 0.1.4 practical-training wording and chapter recalculation

- Replaced a defensive partial-panel disclaimer with direct learning guidance: the lesson now asks listeners to practice the partial-panel control technique with a CFI during flight instruction. The source-supported ACS cross-check point remains intact; no claim mapping changed. The revised approved script contains 5,551 spoken words.
...
- Publication-day validation completed at `2026-08-24T13:37:21.315Z`: all 31 source citations and all 14 show-notes links passed, and each of the 51 reciprocal claims retained a successful claim-level relevance assessment. The show-notes manifest ties every public link to the exact source and claim it supports. No claims changed during release preparation.
