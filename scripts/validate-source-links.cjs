...
const { SOURCE_REVIEW_WHITESPACE_NORMALIZATION, deterministicValidationResultValid, sourceRelevanceResultValid, sourceReviewSemanticInputHashes, sourceValidationInputHashes, validateMasterScriptSourceMappings } = require("./source-validation-contract.cjs");
  ...
  if (refreshedEcfrSources.length) {
    if (finalRefreshAttempt) {
      const report = {
        ...
        input_normalization: { master_script: SOURCE_REVIEW_WHITESPACE_NORMALIZATION },
