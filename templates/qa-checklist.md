...
- [ ] Claim-source preflight findings were resolved before full spoken prose was drafted, and the findings and resolutions are recorded in `production-log.md`. <!-- qa-id: claim-source-preflight -->
